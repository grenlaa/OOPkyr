...
int main() {
	...
	while (poka != 0)
	{
		...
		cout << "11- Востановить очередь" << endl;
		cout << "2 - Удаление объекта" << endl;
		cout << "3 - Отсортировать по ..." << endl;
		cout << "4 - Вывод всей информации об объекте" << endl;
		cout << "5 - Поиск объекта" << endl;
		cout << "6 - Запись в файл" << endl;
		cout << "7 - Вывод всей информации о всех объектах в очереди" << endl;
